...
/**
 * This class is an implementation of a multi-loader HDRF. The first HDRF
 * partitioning method is a single loader, and it is published as: Petroni,
 * Fabio, et al. "HDRF: Stream-Based Partitioning for Power-Law Graphs."
 *
 * @author Hooman
 */
